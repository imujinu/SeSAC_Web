...
class Apartment extends House {
    ...
    // overriding (메소드 재정의)
    // 부모 클래스의 메소드를 이름을 똑같이 쓰고 싶지만 내용은 다르게 만들고 싶을때

    getwindow(){
        console.log(`${this.name}의 창문은 ${this.window}개 입니다. ${this.windowmaker}에서 만들었어요.`)
    }

}

const ap1 = new Apartment ('래미안', 2023, 6, 19, 'kcc')
ap1.getAge()
ap1.getwindow()
